...
def main_slp_linear():
    mnist_train = sio.loadmat('./data/mnist_train.mat')
    mnist_test = sio.loadmat('./data/mnist_test.mat')
...
def visualize_confusion_matrix(confusion, accuracy, label_classes, name):
    ...
    # Save to image
    if(name == 'Single-layer Linear Perceptron Confusion Matrix'):
        plt.savefig('slp_linear.png')
    if(name == 'Single-layer Perceptron Confusion Matrix'):
        plt.savefig('slp.png')
    if(name == 'Multi-layer Perceptron Confusion Matrix'):
        plt.savefig('mlp.png')
    if(name == 'CNN Confusion Matrix'):
        plt.savefig('cnn.png')
    plt.show()
